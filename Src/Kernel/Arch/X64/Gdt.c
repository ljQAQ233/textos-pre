...
static void _GdtSetEnrty (size_t i, u64 Base, u32 Limit, u8 AccessByte, u8 Flgs)
{
    Gdt_t *Ptr = &Gdts[i];
...
void InitializeGdt ()
{
    ...
    _GdtSetEnrty (KERN_CODE_SEG, 0, 0xFFFFF, KERN_CODE_A, CODE_F);
    _GdtSetEnrty (KERN_DATA_SEG, 0, 0xFFFFF, KERN_DATA_A, DATA_F);
    _GdtSetEnrty (USER_CODE_SEG, 0, 0xFFFFF, USER_CODE_A, CODE_F);
    _GdtSetEnrty (USER_DATA_SEG, 0, 0xFFFFF, USER_DATA_A, DATA_F);
